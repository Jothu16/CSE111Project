...
User_AQ = (city_key, user_key, city_key)
cursor.execute("INSERT INTO UserEdits VALUES(?,?,?)", User_AQ)
db.commit()
...
Hist_Stat = (max_hist_key, math.ceil(new_AQI_value / 50), city_key)
cursor.execute("INSERT INTO HistoryStatus VALUES(?,?,?)", Hist_Stat)
db.commit()
...
User_AQ = (max_aq_key, user_key, city_key)
cursor.execute("INSERT INTO UserEdits VALUES(?,?,?)", User_AQ)
db.commit()
max_hist_key += 1
new_history = (max_hist_key, date, AQI_value, city_key)
cursor.execute("INSERT INTO History VALUES(?,?,?,?)", new_history)
Hist_Stat = (max_hist_key, math.ceil(AQI_value / 50), city_key)
cursor.execute("INSERT INTO HistoryStatus VALUES(?,?,?)", Hist_Stat)
db.commit()
