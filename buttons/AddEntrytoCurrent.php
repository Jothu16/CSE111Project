<?php
    function newentrytoaqdatabase($user_key, $city, $date, $aqi_val) {
        ...
        if (!is_int($check["User_Key"])){
            ...
            $sql = "INSERT INTO Current_AQ_Info(Date, AQI_Value, City_Key) VALUES('" . $date . "', " . $aqi_val . ", " . $city_key["City_Key"] . ")";
    ...
    newentrytoaqdatabase($_POST["login"], $_POST["city_name"], $_POST["new_date"], $_POST["new_AQI_value"]);
